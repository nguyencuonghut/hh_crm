...
<div class="form-group form-inline">
    ...
    {!! Form::select('roles', $roles, isset($user->role->role_id) ? $user->role->role_id : null, ['id'=>'role', 'name'=>'roles','class'=>'form-control']) !!}

    {!! Form::label('departments', __('Phòng/ban:'), ['class' => 'control-label']) !!}
    {!! Form::select('departments', $departments, isset($user) ? $user->department->first()->id : null, ['id'=>'department', 'name'=>'departments','class'=>'form-control']) !!}

    {!! Form::label('locales', __('Vùng kinh doanh'), ['class' => 'control-label']) !!}
    {!! Form::select('locales', $locales, isset($user) ? $user->locale->first()->id : null, ['id'=>'locale', 'name'=>'locales','class'=>'form-control']) !!}
</div>
